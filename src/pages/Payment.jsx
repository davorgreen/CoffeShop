...
function Payment() {
    ...
    const [form, setForm] = useState({ fullName: '', address: '', email: '', phoneNumber: '', paymentMethod: paymentMethod, });
    ...
    function handleSubmit(e) {
        ...
        setForm({ fullName: '', address: '', email: '', phoneNumber: '', paymentMethod: paymentMethod, });
    }
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <div className="flex flex-row items-center justify-center ">
                            ...
                            <button className="px-2 py-1S" onClick={() => handleCoupon()} ><span className="bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-full text-white">Apply</span></button>
                        </div>
                    </div>
                    ...
                    <button type="submit"
                        className="w-full mt-3 bg-green-600 text-white p-2 rounded hover:bg-green-700 transition-all" onClick={handleProcessPayment} >Process Payment</button>
                </form>
            </div>
            {isCardOpen && (<div className="fixed inset-0 flex items-center justify-center bg-gray-700 bg-opacity-50 z-50">
